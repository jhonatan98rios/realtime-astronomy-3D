...
export class NeptuneModel {
    ...
    loadTextures() {
        ...
        this.textures.ringTexture = textureLoader.load('neptune/neptuneringcolourSat.png');
        this.textures.ringAlpha = textureLoader.load('neptune/neptunealphaSat.png');
    ...
    loadGeometry() {
        ...
        // Geometria de neptune
        const neptuneGeometry = new THREE.SphereGeometry(1, 32, 32);
        this.mesh = new THREE.Mesh(neptuneGeometry, neptuneMaterial);
