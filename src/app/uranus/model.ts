...
export class UranusModel {
    ...
    loadTextures() {
        ...
        this.textures.ringTexture = textureLoader.load('uranus/uranusringcolour.jpg');
        this.textures.ringAlpha = textureLoader.load('uranus/uranusalpha.png');
    ...
    loadGeometry() {
        ...
        // Geometria de uranuso
        const uranusGeometry = new THREE.SphereGeometry(1, 32, 32);
        this.mesh = new THREE.Mesh(uranusGeometry, uranusMaterial);
    ...
    loadRings() {
        const ringGeometry = new THREE.RingGeometry(2, 2.1, 64); // Raio interno e externo dos anéis
    ...
    loadMoons() {
        ...
        for (let i = 0; i < numMoons; i++) {
            ...
            const textureLoader = new THREE.TextureLoader();
            const textures = {
                moonTexture: textureLoader.load('uranus/moons/texture.jpg'),
            }
